...
<!-- Mirrored from preview.freethemescloud.com/oswan/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 16:15:32 GMT -->
<head>
        <meta charset="utf-8">
                            ...
                            <div class="col-lg-6">
                                <div class="contact-message-wrapper">
                                    ...
                                    <div class="contact-message">
                                        <form id="contact-form" action="http://preview.freethemescloud.com/oswan/assets/Frontend/mail.php" method="post">
                                            <div class="row">
                                                <div class="col-lg-6">
		...
		<script>
            function init() {
                ...
                var marker = new google.maps.Marker({
                    ...
                    map: map,
                    icon: 'assets/Frontend/img/icon-img/8.png',
