...
<div class="container">
    <nav aria-label="breadcrumb" class="breadcrumb-nav ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/shop">Danh sách xe</a></li>
            </a></li>
        ...
        <div class="row">
            <div class="col-lg-3">
                        ...
                        <div class="widget-categories">
                            <ul>
                                {{-- @foreach ($brands as $brand)
                                            <li><a href="/shop/{{ $brand->BrandName }}">{{ $brand->BrandName }}</a></li>
                                        @endforeach --}}
                ...
                <div class="sidebar-widget pb-50">
                    ...
                    <div class="widget-categories">
                        <ul>
                            @foreach ($vehicles->unique('location') as $vehicle)
                                <li>
                                    <a href="{{ url('/shop/location/' . $vehicle->location) }}">
                                        {{ $vehicle->location }}
                                    </a>
                                </li>
                            @endforeach
        ...
        <div class="col-lg-9">
            ...
            <div class="grid-list-product-wrapper tab-content">
                <div id="new-product" class="product-grid product-view tab-pane active">
                    <div class="row">
                        @if ($vehicles->isEmpty())
                            <p class="trong-xe" style="text-align: center">Không tìm thấy xe phù hợp mà
                                bạn mong muốn</p>
                        @else
