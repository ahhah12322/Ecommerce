                                    ...
                                    <div id="lg1" class="tab-pane active">
                                        <div class="login-form-container">
                                            <div class="login-form">
                                                <p class="text-center">Mego vừa gởi mã OTP vào email của bạn. Vui lòng nhập mã đã nhận vào ô bên dưới để xác minh.</p>
                                                <form action="#" method="post">
                                                    <input name="user-email" placeholder="Nhập mã otp từ email" type="email">
                                                    <input type="password" name="user-password" placeholder="Mật khẩu mới">
                                                    <input type="password" name="user-password" placeholder="Lặp lại mật khẩu mới">
