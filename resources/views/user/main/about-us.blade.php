            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="overview-content">
                        <h1><span>MEGO</span></h1>
                        <h2>THUÊ XE <span>DU LỊCH TỰ LÁI</span></h2>
                        <p><span>MEGO</span> là website trực tuyến cho thuê và chia sẻ xe máy tự lái dành cho các khách
                            du lịch trong nước</p>
                        <div class="question-area">
                            <h4>CÓ THỂ LIÊN HỆ: </h4>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-services orange mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="assets/Frontend/img/icon-img/3.png">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services yellow mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="assets/Frontend/img/icon-img/4.png">
                        </div>
                        <div class="services-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services purple mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="assets/Frontend/img/icon-img/5.png">
                        </div>
                        <div class="services-text">
                            <h5>MONEY RETURN</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services sky mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="assets/Frontend/img/icon-img/6.png">
                        </div>
                        <div class="services-text">
