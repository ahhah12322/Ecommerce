                            ...
                            <div class="product-sidebar-area pr-10">
                                ...
                                <div class="sidebar-widget pb-50">
                                        ...
                                        <div class="widget-categories">
                                            <ul>
                                                <li><a href="#">Nhận xe: 11/11/2019</a></li>
                                                <li><a href="#">Trả xe: 12/11/2019</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                <div class="sidebar-widget pb-50">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="product-width col-md-6 col-xl-6 col-lg-6">
                                            <div class="product-wrapper mb-35">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img src="assets/Frontend/img/product/honda-super-cub.png" alt="">
                                                    </a>
                                                    <div class="product-item-dec">
                                                        <ul>
                                                            <li>2018</li>
                                                    ...
                                                    <div class="product-content-wrapper">
                                                            <div class="product-title-spreed">
                                                                <h4><a href="product-details.html">Honda Cub</a></h4>
                                                                <span>110 CC</span>
                                                            </div>
                                                            <div class="product-price">
                                                                <span>120,000 đ/ngày</span>
                                        ...
                                        <div class="product-width col-md-6 col-xl-6 col-lg-6">
                                            <div class="product-wrapper mb-35">
                                                <div class="product-img">
                                                    ...
                                                    <div class="product-content-wrapper">
                                                            <div class="product-title-spreed">
                                                                <h4><a href="product-details.html">Honda Wave RSX</a></h4>
                                                                <span>110 CC</span>
                                                            </div>
                                                            <div class="product-price">
                                                                <span>120,000 đ/ngày</span>
