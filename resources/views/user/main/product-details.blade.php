...
<!-- Mirrored from preview.freethemescloud.com/oswan/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 16:12:46 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="/assets/Frontend/css/easyzoom.css">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-4">
                            <div class="logo-small-device">
                                <a class="logo-sticky-none" href="index.html"><img alt=""
                                        src="/assets/Frontend/img/logo/2.png"></a>
                                <a class="logo-for-sticky" href="index.html"><img alt=""
                                        src="/assets/Frontend/img/logo/logo.png"></a>
                            </div>
                        </div>
                                ...
                                <div class="menu-wrapper text-center">
                                    <button class="menu-toggle menu-sticky-none">
                                        <img class="s-open" alt=""
                                            src="/assets/Frontend/img/icon-img/menu-2.png">
                                        <img class="s-close" alt=""
                                            src="/assets/Frontend/img/icon-img/menu-close-2.png">
                                    </button>
                                                        ...
                                                        <li class="mega-menu-img">
                                                            <ul>
                                                                <li><a class="dot-none" href="shop.html"><img
                                                                            alt=""
                                                                            src="/assets/Frontend/img/banner/17.jpg"></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                    ...
                                    <ul>
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="/assets/Frontend/img/cart/cart-1.jpg"></a>
                                            </div>
                                        ...
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="/assets/Frontend/img/cart/cart-2.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                        ...
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="/assets/Frontend/img/cart/cart-3.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                                <h3><a href="#">Demonissi Gori</a></h3>
                                                <span>Price: $275</span>
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="outstanding-features">
                                                    ...
                                                    <div class="wrap-svg">
                                                        <svg width="32" height="32" viewBox="0 0 32 32"
                                                            ...
                                                            <circle cx="23.9997" cy="23.9999" r="1.91667"
                                                                stroke="#5FCF86" stroke-width="1.5"></circle>
                                                            <path
                                                ...
                                                <div class="outstanding-features__item">
                                                    ...
                                                    <div class="title">
                                                        ...
                                                        <p class="main">
                                                            {{ $vehicle->battery_capacity }}/{{ $vehicle->max_range }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-overview">
                                                ...
                                                <div class="features-car">
                                                    <ul>
                                                        ...
                                                        <li><img loading="lazy"
                                                                ...
                                                                alt="Mioto - Thuê xe tự lái"> Cảm biến lốp</li>
                                                        <li><img loading="lazy"
                                                        ...
                                                        <li><img loading="lazy"
                                                                ...
                                                                alt="Mioto - Thuê xe tự lái"> Cửa sổ trời</li>
                                                        <li><img loading="lazy"
                                            ...
                                            <div class="product-overview">
                                                ...
                                                <div class="required-papers">
                                                    <p>15 triệu (tiền mặt/chuyển khoản cho chủ xe khi nhận xe)hoặc Xe
                                            ...
                                            <div class="product-overview">
                                                ...
                                                <p> ◦ Khi trả xe, nếu xe bẩn hoặc có mùi trong xe, khách hàng vui lòng
                                            ...
                                            <div class="product-categories">
                                                ...
                                                <div class="desc-note">
                                                    <p>* Chính sách hủy chuyến áp dụng chung cho cả khách thuê và chủ xe
                                                        (ngoài ra, tùy vào thời điểm hủy chuyến, chủ xe có thể bị đánh
                                                        giá từ 2-3* trên hệ thống).</p>
                                                    <p>* Khách thuê không nhận xe sẽ mất phí hủy chuyến (33% giá trị
                                                        chuyến đi).</p>
                                                    <p>* Chủ xe không giao xe sẽ hoàn tiền giữ chỗ &amp; bồi thường phí
                                                        hủy chuyến cho khách thuê (33% giá trị chuyến đi).</p>
                                                    <p class="df-align-center">* Tiền giữ chỗ &amp; bồi thường do chủ
                                                            ...
                                                            <span class="wrap-svg">
                                                                <svg width="24" height="24"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        stroke-linecap="round"
                                                                        stroke-linejoin="round"></path>
                                                                    <path d="M12 17H12.01" stroke="black"
                                                                        stroke-width="1.5" stroke-linecap="round"
                                                                        stroke-linejoin="round"></path>
                                                                </svg></span><span class="tooltip-text">
                                                                <b>Thủ tục hoàn tiền &amp; bồi thường hủy
                                                                    chuyến</b>Mioto sẽ hoàn lại tiền giữ chỗ (&amp; tiền
                                                                bồi thường do chủ xe hủy chuyến (nếu có) theo chính sách
                                                                hủy chuyến) qua tài khoản ngân hàng của khách thuê trong
                                                                vòng 1-3 ngày làm việc kể từ thời điểm hủy chuyến.
                                                                <i>*Nhân viên Mioto sẽ liên hệ khách thuê (qua số điện
                                                                    thoại đã đăng ký trên Mioto) để xin thông tin tài
                                                                    khoản ngân hàng, hoặc Khách thuê có thể chủ động gửi
                                                                    thông tin cho Mioto qua email Contact@mioto.vn hoặc
                                        ...
                                        <div class="col-md-12">
                                            <form method="post" action="" id="form" role="form"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- Send Button -->
                                                    <div class="form-group col-md-12">
                                                        <button class="btn-lg btn-warning btn-block "
