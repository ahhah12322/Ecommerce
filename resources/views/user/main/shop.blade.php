...
<!-- Mirrored from preview.freethemescloud.com/oswan/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 16:12:39 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="logo-small-device">
                                    <a class="logo-sticky-none" href="index.html"><img alt="" src="assets/Frontend/img/logo/2.png"></a>
                                    <a class="logo-for-sticky" href="index.html"><img alt="" src="assets/Frontend/img/logo/logo.png"></a>
                                </div>
                            </div>
                                ...
                                <div class="header-contact-menu-wrapper pl-45">
                                    ...
                                    <div class="menu-wrapper text-center">
                                        <button class="menu-toggle menu-sticky-none">
                                            <img class="s-open" alt="" src="assets/Frontend/img/icon-img/menu-2.png">
                                            <img class="s-close" alt="" src="assets/Frontend/img/icon-img/menu-close-2.png">
                                        </button>
                                                    ...
                                                    <li><a href="shop.html">shop</a>
                                                        <ul class="mega-menu">
                                                            ...
                                                            <li class="mega-menu-img">
                                                                <ul>
                                                                    <li><a class="dot-none" href="shop.html"><img alt="" src="assets/Frontend/img/banner/17.jpg"></a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                    </li>
                                        ...
                                        <ul>
                                            <li class="single-shopping-cart">
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="" src="assets/Frontend/img/cart/cart-1.jpg"></a>
                                                </div>
                                            ...
                                            <li class="single-shopping-cart">
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="" src="assets/Frontend/img/cart/cart-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                            ...
                                            <li class="single-shopping-cart">
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="" src="assets/Frontend/img/cart/cart-3.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h3><a href="#">Demonissi Gori</a></h3>
                                                    <span>Price: $275</span>
                                    ...
                                    <div class="best-seller">
                                        <div class="single-best-seller">
                                            <div class="best-seller-img">
                                                <a href="#"><img src="assets/Frontend/img/product/product-12.jpg" alt=""></a>
                                            </div>
                                        ...
                                        <div class="single-best-seller">
                                            <div class="best-seller-img">
                                                <a href="#"><img src="assets/Frontend/img/product/product-13.jpg" alt=""></a>
                                            </div>
                                            <div class="best-seller-text">
                                                <h3><a href="#">Minimal White Shoes</a></h3>
                                                <span>$39.9</span>
                                        ...
                                        <div class="single-best-seller">
                                            <div class="best-seller-img">
                                                <a href="#"><img src="assets/Frontend/img/product/product-14.jpg" alt=""></a>
                                            </div>
                                            <div class="best-seller-text">
                                                <h3><a href="#">Minimal White Shoes</a></h3>
                                                <span>$39.9</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                            <div class="product-wrapper mb-35">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img src="assets/Frontend/img/product/product-9.jpg" alt="">
                                                    </a>
                                                    <div class="product-item-dec">
                                                        <ul>
                                                            <li>2018</li>
                                        ...
                                        <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                            <div class="product-wrapper mb-35">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img src="assets/Frontend/img/product/product-10.jpg" alt="">
                                                    </a>
                                                    <div class="product-item-dec">
                                                        <ul>
                                                            <li>2018</li>
                                        ...
                                        <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                            <div class="product-wrapper mb-35">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img src="assets/Frontend/img/product/product-11.jpg" alt="">
                                                    </a>
                                                    <div class="product-item-dec">
                                                        <ul>
                                                            <li>2018</li>
                                ...
                                <div class="quick-view-learg-img">
                                    <div class="quick-view-tab-content tab-content">
                                        <div class="tab-pane active show fade" id="modal1" role="tabpanel">
                                            <img src="assets/Frontend/img/quick-view/l1.jpg" alt="">
                                        </div>
                                        <div class="tab-pane fade" id="modal2" role="tabpanel">
                                            <img src="assets/Frontend/img/quick-view/l2.jpg" alt="">
                                        </div>
                                        <div class="tab-pane fade" id="modal3" role="tabpanel">
                                            <img src="assets/Frontend/img/quick-view/l3.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="quick-view-list nav" role="tablist">
                                    <a class="active" href="#modal1" data-toggle="tab" role="tab">
                                        <img src="assets/Frontend/img/quick-view/s1.jpg" alt="">
                                    </a>
                                    <a href="#modal2" data-toggle="tab" role="tab">
                                        <img src="assets/Frontend/img/quick-view/s2.jpg" alt="">
                                    </a>
                                    <a href="#modal3" data-toggle="tab" role="tab">
                                        <img src="assets/Frontend/img/quick-view/s3.jpg" alt="">
                                    </a>
                                </div>
                            </div>
...
<!-- Mirrored from preview.freethemescloud.com/oswan/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 16:12:46 GMT -->
</html>
