            ...
            <div class="row">
                <div class="col-lg-5 col-12 col-md-12">
                    <div class="newsletter-img bg-img"
                        ...
                        <img alt="image" src="{{ asset('/assets/Frontend/img/team/newsletter-img.png') }}">
                    </div>
                </div>
                <div class="col-lg-7 col-12 col-md-12">
                    <div class="newsletter-wrapper text-center">
                        ...
                        <div id="mc_embed_signup" class="subscribe-form">
                            <form action="/subscribe" method="post" id="mc-embedded-subscribe-form"
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="footer-widget mb-30">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="{{ asset('/assets/Frontend/img/logo/megologo.png') }}" alt="">
                            </a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="footer-payment-method">
                        <a href="#"><img alt=""
                                src="{{ asset('/assets/Frontend/img/icon-img/payment.png') }}"></a>
                    </div>
                </div>
            </div>
        </div>
