...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:34 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
                            ...
                            <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end"
                                ...
                                <div data-simplebar style="max-height: 280px;">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('assets/Backend/images/users/avatar-1.jpg')}}"
                            ...
                            <a type="button" class="topbar-button" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle" width="32"
                                        src="{{ asset('assets/Backend/images/users/avatar-1.jpg')}}" alt="avatar-3">
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                        ...
                        <div class="position-relative ms-2">
                                ...
                                <div class="mb-4">
                                    <span
                                        class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img
                                            src="{{ asset('assets/Backend/images/users/avatar-7.jpg')}}" alt="avatar-5"
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <div class="row g-2 mt-2">
                                            <div class="col-lg-4">
                                                <a href="#!">
                                                    <img src="{{ asset('assets/Backend/images/small/img-6.jpg')}}"
                                            ...
                                            <div class="col-lg-4">
                                                <a href="#!">
                                                    <img src="{{ asset('assets/Backend/images/small/img-4.jpg')}}"
                                                        alt="" class="img-fluid rounded">
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="position-relative ps-4">
                                <div class="mb-4">
                                    <span
                                        class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img
                                            src="{{ asset('assets/Backend/images/users/avatar-6.jpg')}}" alt="avatar-5"
                                            class="avatar-sm rounded-circle"></span>
                                    <div class="ms-2">
