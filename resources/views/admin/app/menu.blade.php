                  ...
                  <ul class="navbar-nav" id="navbar-nav">
                      ...
                      <li class="nav-item">
                          <a class="nav-link menu-arrow" href="#sidebarProducts" data-bs-toggle="collapse"
                              ...
                              <span class="nav-text"> Danh Sách Xe </span>
                          </a>
                          <div class="collapse" id="sidebarProducts">
                              <ul class="nav sub-navbar-nav">
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('vehical-list') }}">List</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('vehical-grid') }}">Grid</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('vehical-add1') }}">Thêm Xe</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
                              ...
                              <ul class="nav sub-navbar-nav">
                                  ...
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link"
                                          href="{{ route('customer.detail', ['id' => 13]) }}">Details</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
