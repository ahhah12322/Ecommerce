...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/invoice-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:47 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Invoices Create | Larkon - Responsive Admin Dashboard Template</title>
...
<body>
               ...
               <div class="container-fluid">
                    <div class="navbar-header">
                         <div class="d-flex align-items-center">
                              ...
                              <!-- Menu Toggle Button -->
                              <div class="topbar-item">
                                   <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Invoices Create</h4>
                              </div>
                         </div>
                                                       ...
                                                       <div class="">
                                                            <div class="w-50 auth-logo border border-primary bg-light-subtle p-2 rounded" style="border-style: dashed !important;">
                                                                 <div class="profile-photo-edit">
                                                                      ...
                                                                      <label for="profile-img-file-input" class="profile-photo-edit avatar-xs"><img src="assets/Backend/images/logo-dark.png" class="logo-dark me-1 user-profile-image" alt="user-profile-image" height="24"></label>
                                                                 </div>
                                                            </div>
                                                            <div class="mt-5 pt-2">
                                                                 <form>
     ...
     <script src="assets/Backend/js/pages/invoice-add.js"></script>

</body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/invoice-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:48 GMT -->
</html>
