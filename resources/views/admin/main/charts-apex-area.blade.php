...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/charts-apex-area.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:05 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Apex Area Chart | Larkon - Responsive Admin Dashboard Template</title>
...
<body>
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Area Charts</h4>
                            </div>
                       </div>
                    ...
                    <div class="col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0"><span class="fw-medium">Find the JS file for the following chart at:</span> <code> ../src/assets/Backend/js/components/apexchart-area.js</code></p>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="pt-2 pb-2">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <img src="assets/Backend/images/users/avatar-2.jpg" class="avatar-xs rounded" alt="file-image">
                                            </div>
                                            <div class="col ps-0">
    ...
    <script src="../../../apexcharts.com/samples/assets/Backend/stock-prices.js"></script>
    <script src="../../../apexcharts.com/samples/assets/Backend/series1000.js"></script>
    <script src="../../../apexcharts.com/samples/assets/Backend/github-data.js"></script>
    <script src="../../../apexcharts.com/samples/assets/Backend/irregular-data-series.js"></script>

    <!-- Apex Chart Area Demo js -->
    <script src="assets/Backend/js/components/apexchart-area.js"></script>

</body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/charts-apex-area.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:08 GMT -->
</html>
