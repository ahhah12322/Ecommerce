@include('admin.app.header')
    ...
    <!-- Full Calendar -->
    <script src="assets/Backend/vendor/fullcalendar/main.min.js"></script>

    <!-- Page Js -->
    <script src="assets/Backend/js/pages/app-calendar.js"></script>

</body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/apps-calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:58 GMT -->
</html>
