@include('admin.app.header')
                                    ...
                                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                         <div class="carousel-inner" role="listbox">
                                              <div class="carousel-item active">
                                                   <img src="../../assets/Backend/images/product/p-1.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                              <div class="carousel-item">
                                                   <img src="../../assets/Backend/images/product/p-10.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                              <div class="carousel-item">
                                                   <img src="../../assets/Backend/images/product/p-13.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                              <div class="carousel-item">
                                                   <img src="../../assets/Backend/images/product/p-14.png" alt="" class="img-fluid bg-light rounded">
                                              </div>
                                         ...
                                         <div class="carousel-indicators m-0 mt-2 d-lg-flex d-none position-static h-100">
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" class="w-auto h-auto rounded bg-light active">
                                                   <img src="../../assets/Backend/images/product/p-1.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1" aria-label="Slide 2" class="w-auto h-auto rounded bg-light">
                                                   <img src="../../assets/Backend/images/product/p-10.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2" aria-label="Slide 3" class="w-auto h-auto rounded bg-light">
                                                   <img src="../../assets/Backend/images/product/p-13.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                              <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3" aria-label="Slide 3" class="w-auto h-auto rounded bg-light">
                                                   <img src="../../assets/Backend/images/product/p-14.png" class="d-block avatar-xl" alt="swiper-indicator-img">
                                              </button>
                                         </div>
                                    </div>
                               </div>
                          ...
                          <div class="card">
                               ...
                               <div class="card-body">
                                    <div class="d-flex align-items-center gap-2">
                                         <img src="../../assets/Backend/images/users/avatar-6.jpg" alt="" class="avatar-md rounded-circle">
                                         <div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                         <img src="../../assets/Backend/images/users/avatar-4.jpg" alt="" class="avatar-md rounded-circle">
                                         <div>
    ...
    <script src="../../assets/Backend/js/pages/product-details.js"></script>

</body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:43 GMT -->
</html>
