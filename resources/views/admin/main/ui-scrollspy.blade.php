...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/ui-scrollspy.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:03 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Scrollspy | Larkon - Responsive Admin Dashboard Template</title>
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Scrollspy</h4>
                            </div>
                       </div>
