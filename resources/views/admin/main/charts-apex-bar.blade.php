...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/charts-apex-bar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:08 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Apex Bar Charts | Larkon - Responsive Admin Dashboard Template</title>
...
<body>
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Apex Bar Charts</h4>
                            </div>
                       </div>
                    ...
                    <div class="col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0"><span class="fw-medium">Find the JS file for the following chart at:</span> <code> ../src/assets/Backend/js/components/apexchart-bar.js</code></p>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
    ...
    <script src="assets/Backend/js/components/apexchart-bar.js"></script>
