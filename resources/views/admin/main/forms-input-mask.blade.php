...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/forms-input-mask.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:17 GMT -->
<head>
          <!-- Title Meta -->
          <meta charset="utf-8" />
          <title>Input Mask | Larkon - Responsive Admin Dashboard Template</title>
                    ...
                    <div class="container-fluid">
                         <div class="navbar-header">
                              <div class="d-flex align-items-center">
                                   ...
                                   <!-- Menu Toggle Button -->
                                   <div class="topbar-item">
                                        <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Input Mask</h4>
                                   </div>
                              </div>
