...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/help-center.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:58 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Help Center | Larkon - Responsive Admin Dashboard Template</title>
               ...
               <div class="container-fluid">
                    <div class="navbar-header">
                         <div class="d-flex align-items-center">
                              ...
                              <!-- Menu Toggle Button -->
                              <div class="topbar-item">
                                   <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Help Center</h4>
                              </div>
                         </div>
          ...
          <div class="page-content">
               ...
               <div class="container-xxl">
                    <div class="row justify-content-center">
                         <div class="col-lg-12">
                              <div class="card overflow-hidden" style="background: url('assets/Backend/images/small/img-2.jpg'); ">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-1.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-2.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-3.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-4.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-5.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-6.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-7.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-8.jpg" alt="user photo" class="avatar-sm rounded-circle">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                             <img src="assets/Backend/images/users/avatar-9.jpg" alt="user photo" class="avatar-sm rounded-circle">
