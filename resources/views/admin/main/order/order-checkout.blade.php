                                                                           ...
                                                                           <div class="d-flex align-items-center p-2 rounded gap-2 border">
                                                                                <div class="d-flex align-items-center gap-2">
                                                                                     <div class="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                                          <img src="../../assets/Backend/images/brands/dhl.png" alt="" class="avatar rounded">
                                                                                     </div>
                                                                                     <div>
                                                                 ...
                                                                 <div class="form-check form-checkbox-primary ps-0">
                                                                      <label for="shipping-2" class="w-100">
                                                                           <div class="d-flex align-items-center p-2 rounded gap-2 border">
                                                                                <div class="d-flex align-items-center gap-2">
                                                                                     <div class="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                                          <img src="../../assets/Backend/images/brands/fedex.png" alt="" class="avatar rounded">
                                                                                     </div>
                                                                                     <div>
                                                                                          <h5 class="text-dark fw-medium">
                                                                                               FedEx Services
                                                                 ...
                                                                 <div class="form-check form-checkbox-primary ps-0">
                                                                      <label for="shipping-3" class="w-100">
                                                                           <div class="d-flex align-items-center p-2 rounded gap-2 border">
                                                                                <div class="d-flex align-items-center gap-2">
                                                                                     <div class="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                                          <img src="../../assets/Backend/images/brands/ups.png" alt="" class="avatar rounded">
                                                                                     </div>
                                                                                     <div>
                                                                                          <h5 class="text-dark fw-medium">
                                                                                               UPS Services
                                                                           ...
                                                                           <h2 class="mb-0">
                                                                                <button class="btn btn-light w-100 collapsed rounded-0 border-bottom rounded-top-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                                     <div class="d-flex align-items-center justify-content-between">
                                                                                          ...
                                                                                          <img src="../../assets/Backend/images/card/paypal.svg" alt="" class="avatar-sm">
                                                                                     </div>
                                                                                </button>
                                                                           </h2>
                                                                           <p class="p-3 mb-0">
                                                                                ...
                                                                                <button class="btn btn-light w-100 collapsed rounded-0 border-bottom rounded-top-1" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                                     <div class="d-flex align-items-center justify-content-between">
                                                                                          ...
                                                                                          <div class="icons text-end">
                                                                                               <img src="../../assets/Backend/images/card/mastercard.svg" alt="" class="avatar-sm">
                                                                                               <img src="../../assets/Backend/images/card/stripe.svg" alt="" class="avatar-sm">
                                                                                               <img src="../../assets/Backend/images/card/visa.svg" alt="" class="avatar-sm">
                                                                                          </div>
                                                                                     </div>
                                                                                </button>
                                                                           </h2>
                                        ...
                                        <div class="table-responsive">
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  <div class="rounded bg-light avatar d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-1.png" alt="" class="avatar">
                                                  </div>
                                                  <div>
                                             ...
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  <div class="rounded bg-light avatar d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-5.png" alt="" class="avatar">
                                                  </div>
                                                  <div>
                                             ...
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  <div class="rounded bg-light avatar d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-8.png" alt="" class="avatar">
                                                  </div>
                                                  <div>
                                             ...
                                             <div class="d-flex align-items-center gap-3 mb-4">
                                                  <div class="rounded bg-light avatar d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-10.png" alt="" class="avatar">
                                                  </div>
                                                  <div>
                                                       ...
                                                       <div class="row align-items-center">
                                                            <div class="col-lg-12">
                                                                 <div class="check-icon text-center">
                                                                      <img src="../../assets/Backend/images/party.png" alt="" class="img-fluid">
                                                                 ...
                                                                 <div class="row justify-content-between mt-3 align-items-center">
                                                                      ...
                                                                      <div class="col-lg-4 col-6 text-end">
                                                                           <img src="../../assets/Backend/images/users/avatar-1.jpg" alt="" class="avatar rounded-circle">
                                                                      </div>
                                                                 </div>
                                                                 <div class="row justify-content-between mt-3 align-items-center">
                                                                      <div class="col-lg-6 col-6">
...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/order-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:47 GMT -->
</html>
