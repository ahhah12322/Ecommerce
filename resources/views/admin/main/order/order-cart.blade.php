                                        ...
                                        <div class="row gy-3">
                                             <div class="col-sm-auto">
                                                  <div class="rounded bg-light avatar-lg d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-1.png" alt="" class="avatar-lg">
                                                  </div>
                                             </div>
                                             <div class="col-sm">
                                                  <div class="ms-lg-3">
                              ...
                              <div class="card cart-detail">
                                   <div class="card-body">
                                        <div class="row gy-3">
                                             <div class="col-sm-auto">
                                                  <div class="rounded bg-light avatar-lg d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-5.png" alt="" class="avatar-lg">
                                                  </div>
                                             </div>
                                             <div class="col-sm">
                                                  <div class="ms-lg-3">
                              ...
                              <div class="card cart-detail">
                                   <div class="card-body">
                                        <div class="row gy-3">
                                             <div class="col-sm-auto">
                                                  <div class="rounded bg-light avatar-lg d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-8.png" alt="" class="avatar-lg">
                                                  </div>
                                             </div>
                                             <div class="col-sm">
                                                  <div class="ms-lg-3">
                              ...
                              <div class="card cart-detail">
                                   <div class="card-body">
                                        <div class="row gy-3">
                                             <div class="col-sm-auto">
                                                  <div class="rounded bg-light avatar-lg d-flex align-items-center justify-content-center">
                                                       <img src="../../assets/Backend/images/product/p-10.png" alt="" class="avatar-lg">
                                                  </div>
                                             </div>
                                             <div class="col-sm">
                                                  <div class="ms-lg-3">
