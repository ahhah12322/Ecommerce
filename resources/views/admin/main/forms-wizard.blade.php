...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/forms-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:15 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Wizard | Larkon - Responsive Admin Dashboard Template</title>
...
<body>
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Wizard</h4>
                            </div>
                       </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="avatar-lg mb-3">
                                                                <div class="avatar-title bg-body rounded-circle border border-3 border-dashed-light position-relative">
                                                                    ...
                                                                    <img id="preview" src="assets/Backend/images/users/dummy-avatar.jpg" alt="Preview Image" class="rounded-circle img-fluid">
                                                                </div>
                                                            </div>
    ...
    <script src="../assets/Backend/js/components/form-wizard.html"></script>

</body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/forms-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:16 GMT -->
</html>
