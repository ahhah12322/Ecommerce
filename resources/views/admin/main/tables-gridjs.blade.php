...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/tables-gridjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:17 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Gridjs Table | Larkon - Responsive Admin Dashboard Template</title>
    ...
    <!-- Gridjs Plugin css -->
    <link href="assets/Backend/vendor/gridjs/theme/mermaid.min.css" rel="stylesheet" type="text/css" />
...
<body>
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Gridjs Table</h4>
                            </div>
                       </div>
    ...
    <!-- Gridjs Plugin js -->
    <script src="assets/Backend/vendor/gridjs/gridjs.umd.js"></script>

    <!-- Gridjs Demo js -->
    <script src="assets/Backend/js/components/table-gridjs.js"></script>

</body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/tables-gridjs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:19 GMT -->
</html>
