...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/invoice-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:47 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
    <title>Invoice Details | Larkon - Responsive Admin Dashboard Template</title>
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Invoice Details</h4>
                            </div>
                       </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="clearfix pb-3 bg-info-subtle p-lg-3 p-2 m-n2 rounded position-relative">
                                    <div class="float-sm-start">
                                        <div class="auth-logo">
                                            <img class="logo-dark me-1" src="assets/Backend/images/logo-dark.png" alt="logo-dark" height="24" />
                                        </div>
                                        <div class="mt-4">
                                            <h4>Larkon Admin.</h4>
                                    ...
                                    <div class="position-absolute top-100 start-50 translate-middle">
                                        <img src="assets/Backend/images/check-2.png" alt="" class="img-fluid">
                                    </div>
                                </div>
