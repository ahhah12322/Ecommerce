...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:20 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Vector Maps | Larkon - Responsive Admin Dashboard Template</title>
...
<body>
               ...
               <div class="container-fluid">
                    <div class="navbar-header">
                         <div class="d-flex align-items-center">
                              ...
                              <!-- Menu Toggle Button -->
                              <div class="topbar-item">
                                   <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Vector Maps</h4>
                              </div>
                         </div>
     ...
     <script src="assets/Backend/js/components/maps-canada.js"></script>
     <script src="assets/Backend/js/components/maps-iraq.js"></script>
     <script src="assets/Backend/js/components/maps-russia.js"></script>
     <script src="assets/Backend/js/components/maps-spain.js"></script>
     <script src="assets/Backend/js/components/maps-us-aea-en.js"></script>
     <script src="assets/Backend/js/components/maps-us-lcc-en.js"></script>
     <script src="assets/Backend/js/components/maps-us-mill-en.js"></script>

     <script src="assets/Backend/js/components/maps-vector.js"></script>

</body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:23 GMT -->
</html>
