...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/forms-editors.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:16 GMT -->
<head>
          <!-- Title Meta -->
          <meta charset="utf-8" />
          <title>Editors | Larkon - Responsive Admin Dashboard Template</title>
     ...
     <body>
                    ...
                    <div class="container-fluid">
                         <div class="navbar-header">
                              <div class="d-flex align-items-center">
                                   ...
                                   <!-- Menu Toggle Button -->
                                   <div class="topbar-item">
                                        <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Editors</h4>
                                   </div>
                              </div>
          ...
          <!-- Quill Editor js -->
          <script src="assets/Backend/js/components/form-quilljs.js"></script>

     </body>


<!-- Mirrored from techzaa.getappui.com/larkon/admin/forms-editors.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:08:17 GMT -->
</html>
