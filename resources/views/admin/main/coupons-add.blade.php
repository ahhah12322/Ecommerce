...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/coupons-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:56 GMT -->
<head>
    <!-- Title Meta -->
    <meta charset="utf-8" />
...
<body>
             ...
             <div class="container-fluid">
                  <div class="navbar-header">
                       <div class="d-flex align-items-center">
                            ...
                            <!-- Menu Toggle Button -->
                            <div class="topbar-item">
                                 <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Coupons Add</h4>
                            </div>
                       </div>
    ...
    <script src="assets/Backend/js/pages/coupons-add.js"></script>
