...
<!-- Mirrored from techzaa.getappui.com/larkon/admin/seller-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:07:55 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
     <title>Seller Details | Larkon - Responsive Admin Dashboard Template</title>
...
<body>
               ...
               <div class="container-fluid">
                    <div class="navbar-header">
                         <div class="d-flex align-items-center">
                              ...
                              <!-- Menu Toggle Button -->
                              <div class="topbar-item">
                                   <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">Seller Details</h4>
                              </div>
                         </div>
                                        ...
                                        <div class="row g-3">
                                             <div class="col-lg-2 text-lg-center">
                                                  <div class="bg-body d-flex align-items-center justify-content-center rounded py-4">
                                                       <img src="assets/Backend/images/seller/zara.svg" alt="" class="avatar-xxl flex-shrink-0">
                                                  </div>
                                                  <div class="mt-3">
     ...
     <script src="assets/Backend/js/pages/seller-detail.js"></script>
